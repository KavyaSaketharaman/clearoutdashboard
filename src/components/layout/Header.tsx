    ...
    <div className="sticky top-0 z-50 w-full font-sans">
      ...
      <div className="w-full bg-gradient-to-r from-[#2e2c1e] via-[#4a4830] to-[#7a7550] px-5 py-2 flex items-center justify-between gap-4">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="flex items-center gap-2 bg-[#3a3820] border border-[#6b6840] rounded-full px-4 py-1 text-sm">
              <span className="text-gray-200">
                ...
                <button className="text-orange-400 font-semibold hover:underline">Learn More →</button>
              </span>
              <button onClick={() => setShowBanner(false)} className="text-gray-400 hover:text-white ml-1 shrink-0">
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <button className="text-gray-300 hover:text-white relative transition-colors">
            ...
            <span className="absolute -top-1.5 -right-1.5 w-4 h-4 bg-orange-500 rounded-full text-[9px] text-white font-bold flex items-center justify-center">1</span>
          </button>
          <div className="flex items-center gap-2 cursor-pointer group">
            ...
            <span className="text-white text-sm font-medium group-hover:text-orange-300 transition-colors">{displayName}</span>
      ...
      <div className="w-full bg-white border-b border-gray-200 px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 shrink-0 pl-4">
          <Button variant="outline" size="sm" className="h-8 px-3 text-xs border-gray-300 text-gray-600 hover:border-gray-400 hover:text-gray-800 flex items-center gap-1.5 rounded-md">
            Review us on <span className="font-extrabold text-orange-500 text-sm">G</span>
          </Button>
          <Button size="sm" className="h-8 px-4 text-xs bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-md shadow">
            Buy Credits
          </Button>
          <Button
